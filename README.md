...
**Institutional-Grade Governance Engine for Liquidity Pool Hunting**
...
1. Copy `YSM-Gomati_HuntTheHunters.mq5` to your MT5 `Experts` folder
2. Compile in MetaEditor (F7)
3. Attach to chart on your preferred timeframe
4. Set `RiskPercent` to match your account risk tolerance
5. Verify `SessionMode` matches your GMT offset setup
...
YSM-GOMATI Architecture — Version 6.00
